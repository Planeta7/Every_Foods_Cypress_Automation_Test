...
describe('Delivery for 16+ meals ', () => {
  ...
  cy.xpath('/html/body/div[1]/div[1]/div[2]/div[2]/div[4]/button').click()
      ...
      cy.xpath('/html/body/div[9]/div/div/div/aside/div[3]/div[2]/div[1]/div/div/span').should('contain','Bitte legen Sie Bowls im Wert von 8 in Ihren Warenkorb, um zur Kasse zu gelangen')
     })
   })