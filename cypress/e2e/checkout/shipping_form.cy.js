...
describe('"Shipping" form filled with valid data', () => {
  it('Should successfully save the data and once the button is clicked, user should be navigated to the "Payment" form', () => {
  ...
  cy.xpath('./html/body/div[1]/div[1]/div/div/div[2]/div[2]/div[1]/div/main/div/div/div/div/div[2]/form/div[1]/div/div/div/div/div[1]/section/div/div[2]/div[1]/div/div/div[2]/div/div/button/span/div/span[1]').click({force: true})
